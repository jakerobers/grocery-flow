...
baked_honey_mustard_chicken = Recipe(
    ...
    ingredients=[
        Ingredient(name="Olive Oil", quantity=4, unit="tbsp"),
        Ingredient(name="Honey", quantity=3, unit="tbsp"),
        Ingredient(name="Whole Grain Mustard", quantity=2, unit="tbsp"),
        ...
        Ingredient(name="Boneless Skinless Chicken Breasts", quantity=2, unit="lbs"),
        ...
        Ingredient(
            name="Fresh Chopped Parsley", quantity=2, unit="tbsp", optional=True
        ),
...
asian_beef_stew = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="cornstarch", quantity=2, unit="tbsp"),
        Ingredient(name="curry powder", quantity=2, unit="tsps"),
...
carrot_cake = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="vanilla extract", quantity=1, unit="tbsp"),
        Ingredient(name="all-purpose flour", quantity=2, unit="cups"),
        Ingredient(name="baking soda", quantity=2, unit="tsps"),
        Ingredient(name="baking powder", quantity=2, unit="tsps"),
        Ingredient(name="salt", quantity=0.5, unit="tsp"),
        Ingredient(name="ground cinnamon", quantity=1, unit="tbsp"),
        Ingredient(name="nutmeg", quantity=0.25, unit="tsps"),
    ...
    instructions=[
        ...
        "In a large bowl, beat together eggs, oil, white sugar, brown sugar, and 3 tsps vanilla. Mix in flour, baking soda, baking powder, salt, nutmeg, and cinnamon. Stir in carrots. Fold in pecans. Pour into prepared pan.",
        "Bake in the preheated oven for 40 to 50 minutes, or until a toothpick inserted into the center of the cake comes out clean. Let cool in pan for 10 minutes, then turn out onto a wire rack and cool completely.",
        "To make frosting: In a medium bowl, combine butter, cream cheese, confectioners' sugar, and 1 tsp vanilla. Beat until the mixture is smooth and creamy. Stir in chopped pecans. Frost the cooled cake.",
    ],
)
...
one_pan_mexican_quinoa = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="fresh cilantro leaves", quantity=2, unit="tbsp"),
    ],
    instructions=[
...
oriental_salad = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="rice vinegar", quantity=4, unit="tbsp"),
        Ingredient(name="sugar", quantity=4, unit="tbsp"),
...
shrimp_pad_thai_bowl = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="dark brown sugar", quantity=10, unit="tbsp"),
        Ingredient(name="fish sauce", quantity=4, unit="tbsp"),
        Ingredient(name="vegetable oil", quantity=10, unit="tbsp"),
        Ingredient(name="rice vinegar", quantity=8, unit="tsps"),
    ...
    instructions=[
        "Whisk lime juice, 3 tbsp water, sugar, fish sauce, 6 tbsp oil, vinegar, and cayenne together in a bowl; set aside.",
        ...
        "Sauté shrimp.",
        "Heat remaining 4 tbsp oil in a 10-inch nonstick skillet over medium-high heat until shimmering. Add lower-half green onion, garlic, and salt and cook over medium heat, stirring constantly, until onion is light golden brown, about 1.5 minutes.",
        "Lightly beat eggs. Stir in egg and cook, stirring vigorously, until scrambled and barely moist, about 20 seconds.",
        "Add drained rice noodles and toss to combine. Add lime mixture and half of the upper-half green onion, increase heat to medium-high, and cook, tossing gently, until noodles are well coated and tender, about 3 minutes. (If not yet tender, add 6-8 tbsp water to skillet and continue to cook until tender).",
...
slow_cooker_chicken_and_rice = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="salt", quantity=0.5, unit="tsp"),
        Ingredient(name="paprika", quantity=0.25, unit="tsp"),
...
tex_mex_beef_wraps = Recipe(
    ...
    ingredients=[
        ...
        Ingredient(name="cumin", quantity=2, unit="tsps"),
        Ingredient(name="salt", quantity=1, unit="tsp"),
        Ingredient(name="red pepper", quantity=0.25, unit="tsp"),
        Ingredient(name="boneless beef chuck pot roast", quantity=3, unit="lbs"),
        Ingredient(name="onion", quantity=1, unit="pcs", preparation="chopped"),
